...
/**
 * @copyright https://fontawesome.com/
 ...
 */
export const arrowsUpDownLeftRight: Icon = {
  viewBox: '0 0 512 512',
...
/**
 * @copyright https://pictogrammers.com/contributor/GreenTurtwig/
 * @see https://pictogrammers.com/library/mdi/icon/image-plus/
 */
...
/**
 * @copyright https://pictogrammers.com/contributor/Templarian/
 * @see https://pictogrammers.com/library/mdi/icon/image-remove/
 * */
export const imageRemove: Icon = {
  viewBox: '0 0 24 24',
